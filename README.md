...
- Check out the full Godoc reference:
  [![GoDoc](https://godoc.org/github.com/snydersalvage/ratchet?status.svg)](https://godoc.org/github.com/snydersalvage/ratchet)
- Get Ratchet:
  go get github.com/snydersalvage/ratchet
  ...
  you can download them into your project's vendor folder--along with ratchet--by running:
        ...
        govendor sync
        govendor add github.com/snydersalvage/ratchet
        govendor add github.com/snydersalvage/ratchet/data
        govendor add github.com/snydersalvage/ratchet/logger
        govendor add github.com/snydersalvage/ratchet/processors
        govendor add github.com/snydersalvage/ratchet/util
